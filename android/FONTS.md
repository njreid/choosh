...
| --- | --- | --- | --- |
| `res/font/geomini.ttf` | Local sibling-project artifact; authoritative upstream identity not yet recorded | `baf3fa2b1078c6a5cac05196889c01d63536ed6233e705262c7e6d4fbefffa59` | General UI body text through `@font/choosh_ui` |
| `res/font/iosevka_charon_mono.ttf` | Local sibling-project artifact; authoritative upstream identity not yet recorded | `ae87c9bc7baae0a18e78cbe498d967865c251cae20fffa0c34e5937ce118f845` | Terminal regular through `@font/choosh_terminal` |
| `res/font/iosevka_charon_mono_bold.ttf` | Local sibling-project artifact; authoritative upstream identity not yet recorded | `d5a0e6259a77a98b086897b3b86f120c1170b85ab5e82f527cf810e239f082cf` | Headings via `Choosh.Text.Heading` and terminal bold through `@font/choosh_terminal` |
...
a local sibling-project licence copy.
...
This local evidence does not establish authoritative upstream provenance. The blocking audit and
remaining evidence requirements are recorded in
[`../docs/licenses/terminal-provenance.md`](../docs/licenses/terminal-provenance.md).
