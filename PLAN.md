...
| M2 — Agents and notifications | **In progress** | Core event spool, adapter normalization, redacted waiting-notification projection, exact-target notification activation, and bounded replay/ack tests pass headlessly. Android notification service wiring, real hook delivery, and the SSH-backed end-to-end subscription remain future gates. |
