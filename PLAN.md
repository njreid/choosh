...
| M5 — Markdown review | **In progress** | Bounded safe-subset rendering and relative-asset gating pass headlessly; Markdown snapshot identity now scopes workspace/document, revision, and deterministic content digest. Annotation persistence, re-anchoring, export, and device acceptance remain. |
